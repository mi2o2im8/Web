<?php
    ...
    //임시저장소에 있는 시레제 파일을 영ㅇ구적으로 서버에 저장하기 위해 이동!
...
<!-- 수행과제 -->
 <!-- 1. [챕터5] 11번, 12번 문제 database 에 저장하기 위한 테이블(표) 만들기 -->
<!-- [챕터5] 11번, 12번 문제 database 에 저장하기 -->
<!-- [chapter5] 11번, 12번 문제 Database 만들고 데이터 불러와서 보여주기 -->